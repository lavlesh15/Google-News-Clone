...
function Technology() {
  ...
  useEffect(() => {
    {
      fetch('https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=d41c8474c2644a9584e021f6fa503d66')
        ...
        <div className="main_body">
              ...
              <div className="heading">
                <div className="heading_left">
                  <img src="https://t4.ftcdn.net/jpg/04/22/84/83/360_F_422848365_CfFo8JRWcMrB930fWwmHjgj28bNiZA9b.jpg" height="100px" width="100px" alt="" />
